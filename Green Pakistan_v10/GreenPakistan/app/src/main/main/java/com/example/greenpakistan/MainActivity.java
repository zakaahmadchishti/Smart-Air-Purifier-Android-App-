...
public class MainActivity extends AppCompatActivity {
    ...
    Button Air_Quality_internal, Humudity_internal, Carbon_internal, myexpoure;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////progress bar
        ...
        dref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                String status2;
                status = dataSnapshot.child("Sensors Data").child("Additional").child("Percentage").getValue().toString();
                ...
                final int pollution1, pollution2, pollution3, pollution4, pollution5, pf,pfa;

                status = dataSnapshot.child("Sensors Data").child("Pollution").child("Reading0").getValue().toString();
                pollution1 = Integer.parseInt(status);
                status = dataSnapshot.child("Sensors Data").child("Pollution").child("Reading1").getValue().toString();
                pollution2 = Integer.parseInt(status);
                status = dataSnapshot.child("Sensors Data").child("Pollution").child("Reading2").getValue().toString();
                pollution3 = Integer.parseInt(status);
                status = dataSnapshot.child("Sensors Data").child("Pollution").child("Reading3").getValue().toString();
                pollution4 = Integer.parseInt(status);
                status = dataSnapshot.child("Sensors Data").child("Pollution").child("Reading4").getValue().toString();
                pollution5 = Integer.parseInt(status);
                pf = (pollution1 + pollution2 + pollution3 + pollution4 + pollution5) / 5;
                conditioncomment.setText("Moderate " + String.valueOf(pf + 0));
